...
type Entry struct {
	Term             uint64    `protobuf:"varint,2,opt,name=Term" json:"Term"`                       // 该日志的对应的任期
	Index            uint64    `protobuf:"varint,3,opt,name=Index" json:"Index"`                     // 日志的索引号（相对值，Index+snapshot.Metadata.Index 才是递增的绝对值）
	Type             EntryType `protobuf:"varint,1,opt,name=Type,enum=raftpb.EntryType" json:"Type"` // 日志的类型
...
type Message struct {
	...
	RejectHint       uint64      `protobuf:"varint,11,opt,name=rejectHint" json:"rejectHint"` // follower 拒绝并且返回的 last index
